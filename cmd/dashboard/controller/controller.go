...
func routers(r *gin.Engine, frontendDist fs.FS) {
	...
	// MCP is disabled in the hardened Dashboard because its former tool surface
	// provided remote command execution and filesystem operations.
	...
	// Server inventory and monitoring routes. Terminal, file-manager, command
	// execution, and filesystem-operation routes are intentionally unavailable
	// in the hardened Dashboard.
